package com.anveshak.client;

import com.anveshak.DTOs.EmbedRequest;
import com.anveshak.DTOs.EmbedResponse;
...
public class EmbeddingServiceClient {
    ...
    public float[] getEmbedding(String text) {
        try {
            ...
            throw new EmbeddingServiceException("Embedding service unavailable");
        } catch (Exception e) {
            log.error("Error calling embedding service", e);
            throw new EmbeddingServiceException("Error calling embedding service");
        }
    }
}
