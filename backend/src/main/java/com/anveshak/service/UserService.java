...
import com.anveshak.Exception.*;
import com.anveshak.model.User;
import com.anveshak.repository.UserIdentityRepository;
import com.anveshak.repository.UserRepository;
...
public class UserService {
    ...
    public User createNewUser(RegisterRequest registerRequest) {
        ...
        final User newUser = new User(registerRequest);
